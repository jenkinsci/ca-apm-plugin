...
public class PluginRunSimulation {
	...
	public void runPluginSimulation(String path, String fileName) throws BuildComparatorException, BuildValidationException, BuildExecutionException {
		...
		JenkinsInfo jenkinsInfo = new JenkinsInfo(35, 29, histogramBuilds, path + "workspace", "CIGNAOne");
		ComparisonRunner runner = new ComparisonRunner(jenkinsInfo,
				path + File.separator + fileName);
		runner.executeComparison();
	}

	public static void main(String[] args) throws BuildComparatorException, BuildValidationException, BuildExecutionException {
