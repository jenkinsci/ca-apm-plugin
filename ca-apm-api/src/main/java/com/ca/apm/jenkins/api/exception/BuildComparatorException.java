...
/**
 * A custom exception for this application. Whenever you want to raise an exception in your
 * implemented entities, you can raise this exception. The plugin task will be stopped
 *
