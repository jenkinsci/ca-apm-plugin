...
/**
 * This entity holds the properties required in the Output-Handling stage. It
 * contains the properties like output directory, build run times, jenkins
 * information, which can be used in the Output-phase
 * 
