...
/**
 * Utility to help you to create a file, folder or exporting an output to file
...
public class FileHelper {
	 ...
	 * 
	 * @param fileName
	 *            Full name of the file along with absolute path
	...
	/**
	 * Create a directory, but no guarantee, it may fail if it is not allowed to
	 * create
	 * 
	 * @param dir
	 *            The directory name which you want to create
	 * @return Returns true if it is successful in creating the desired
	 *         directory or if directory already exists
	 */
	...
	public static void initializeLog(String loggingLevel, String buildDirectory, int currentBuildNumber) {
		...
		if (fileExist) {
			JenkinsPlugInLogger.configureLog(loggingLevel,
					buildDirectory + File.separator + currentBuildNumber + File.separator + "comparison-runner.log");
		}
	 ...
	 *            Folder name where you want to flush the output to
	 * @param fileName
	 *            File Name
	 * @param content
	 *            Content of the file
	...
	public static void exportOutputToFile(String outputDirectory, String fileName, String content) {
		...
		if (created) {
			...
			JenkinsPlugInLogger.severe("Cannot create the " + fileName + "  in folder " + outputDirectory);
		}
	}

	/**
	 * This utility is used to unzip any file and extract it to a given
	 * directory
	 * 
	 * @param zipFilePath
	 *            Complete File path of the Zip File
	 * @param destDir
	 *            The destination directory where the zip has to be extracted
	 */
