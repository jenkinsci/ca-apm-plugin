...
public class IOUtility {
	...
	public void extractZipFromClassPath(String zipFileName, File targetFolder) {
		ClassLoader classLoaderPln = this.getClass().getClassLoader();
		ZipInputStream zipInputStream = new ZipInputStream(classLoaderPln.getResourceAsStream(zipFileName));
		ZipEntry entry = null;
		try {
			...
			try {
				...
				JenkinsPlugInLogger.severe("Exception in closing zipInputStream: " + e.getMessage());
			}
		}
	}
	...
	private void extractFile(ZipInputStream zipIn, String filePath) throws IOException {
		try (BufferedOutputStream bos = new BufferedOutputStream(new FileOutputStream(filePath))) {
			...
			JenkinsPlugInLogger.severe("Exception in extractFile() of IOUtility : " + ex.getMessage());
		}
	}
	...
	public void loadExtensionsLibraries() {
		...
		for (File jar : jarFiles) {
			try {
				...
				JenkinsPlugInLogger
						.severe("Exception during the execution of loadExtensionsLibraries : " + e.getMessage());
			}
		}
