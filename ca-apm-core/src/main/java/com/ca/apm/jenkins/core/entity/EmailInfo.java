...
/**
 * This entity holds the email information which you want to send to the users
 * on the completion of Jenkins Plugin Run The basic fields will be populated by
 * the plug-in based upon the output-handler configuration provided by you. The
 * additional fields have to be set by you.
 * 
