...
/**
 * This entity is the one record of metric performance data which is received
 * from APM. This entity represents list of time-slice values for the given
 * metric-path.TimeSliceValue represents one entry of max, min, value and count
...
public class MetricPerformanceData {
	...
	public String toString() {
		return "MetricPerformanceData [metricPath=" + metricPath + ", timeSliceValues=" + timeSliceValues + "]";
	}
