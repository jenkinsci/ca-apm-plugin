...
/**
 * This entity is placeholder for one metric-path's performance comparison
 * record This object can be created in the Comparison-Strategy and be used for
 * output-reporting. You can see in the default-implementation of
 * comparison-strategies and output-handlers
 * 
...
public class MetricPathComparisonResult {
	...
	public String toString() {
		return "ComparisonOutput [metricPath=" + metricPath + ", expectedValue=" + expectedValue + ", actualValue="
				+ actualValue + ", percentageChange=" + percentageChange + "]";
	}
