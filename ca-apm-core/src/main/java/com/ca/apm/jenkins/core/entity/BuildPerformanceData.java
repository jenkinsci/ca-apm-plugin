...
/**
 * This entity is the placeholder for the metric-performance data collected from
 * EM based upon the comparison-strategy configuration defined in the properties
 * file This is a list of MetricPerformanceData entity, which is the
 * metric-performance data of one metric path
 *
